...
public class camera extends javax.swing.JFrame {
    ...
    static {
        File file = new File("C:\\Users\\chizi\\Downloads\\Open CV\\opencv_java249.dll");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(option == 0) {
            try {
                ...
                registration.jLabel1.setText(Filename);
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                jLabel1.setIcon(ic);
                ImageIcon ic2 = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(registration.jLabel2.getWidth(), registration.jLabel2.getHeight(), Image.SCALE_DEFAULT));
                registration.jLabel2.setIcon(ic2);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Warning!");
        }
